#!/usr/bin/env python3
"""
Script pour exécuter le swap avec 0.001 ETH
"""
...
async def execute_real_swap():
    """Exécute le swap réel pour le token avec 0.001 ETH"""
    print("🚀 EXÉCUTION DU SWAP RÉEL - 0.001 ETH")
    print("=" * 60)
    ...
    eth_amount = 0.001  # 0.001 ETH cette fois
...
async def main():
    """Fonction principale"""
    print("🚀 SCRIPT D'EXÉCUTION DE SWAP - 0.001 ETH")
    print("=" * 60)
    print("⚠️  ATTENTION: Ce script va effectuer une transaction RÉELLE sur Base !")
    print("💰 Vous allez dépenser 0.001 ETH pour acheter des tokens")
    print("=" * 60)
    ...
    if success:
        ...
        print("💡 Vous avez maintenant plus de tokens dans votre wallet")
    else:
